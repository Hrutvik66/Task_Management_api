...
var task_route_1 = __importDefault(require("./routes/task.route"));
var port = 3000;
// express application
var app = (0, express_1.default)();
// sequelize database connection checking functions
var sequelizeConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
...
var createTables = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                console.error("Unable to sync models with the database:", error_2);
                throw error_2;
            case 3: return [2 /*return*/];
        }
    });
...
var startServer = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, sequelizeConnection()];
            case 1:
                _a.sent();
